...
//#region node_modules/.nitro/vite/services/ssr/assets/admin-gate.functions-BUcy5llv.js
...
var adminListTempImages = createServerFn({ method: "GET" }).handler(createSsrRpc("8d7530627dbe02c207c6517cda50ec821daf95dbfe8b42a3d9a988f63356a7f0"));
var adminMapTempImage = createServerFn({ method: "POST" }).inputValidator((d) => d).handler(createSsrRpc("ccdba02ed42fb47eab92077cca5025b3f4524908690fc4f96a544ac5d95a2d4b"));
var adminTestSMTPSend = createServerFn({ method: "POST" }).handler(createSsrRpc("5bd9f8bff78de780c1900d02fdb052e26b9d9b166513234ecea52bdb22e8bbae"));
//#endregion
export { adminUploadMedia as A, adminSaveProduct as C, adminStatus as D, adminSetMediaActive as E, adminTestSMTPSend as O, adminSaveCoupon as S, adminSaveTestimonial as T, adminLogout as _, adminDeleteProduct as a, adminReorderMedia as b, adminListCategories as c, adminListPosts as d, adminListProducts as f, adminLogin as g, adminListTestimonials as h, adminDeletePost as i, useServerFn as j, adminUpdateOrderStatus as k, adminListCoupons as l, adminListTempImages as m, adminDeleteCategory as n, adminDeleteReel as o, adminListReels as p, adminDeleteCoupon as r, adminDeleteTestimonial as s, adminCreatePost as t, adminListOrders as u, adminMapTempImage as v, adminSaveReel as w, adminSaveCategory as x, adminOrderCount as y };
