...
import { t as createSsrRpc } from "./createSsrRpc-DueTp5av.mjs";
import { A as adminUploadMedia, C as adminSaveProduct, D as adminStatus, E as adminSetMediaActive, O as adminTestSMTPSend, S as adminSaveCoupon, T as adminSaveTestimonial, _ as adminLogout, a as adminDeleteProduct, b as adminReorderMedia, c as adminListCategories, d as adminListPosts, f as adminListProducts, h as adminListTestimonials, i as adminDeletePost, j as useServerFn, k as adminUpdateOrderStatus, l as adminListCoupons, m as adminListTempImages, n as adminDeleteCategory, o as adminDeleteReel, p as adminListReels, r as adminDeleteCoupon, s as adminDeleteTestimonial, t as adminCreatePost, u as adminListOrders, v as adminMapTempImage, w as adminSaveReel, x as adminSaveCategory, y as adminOrderCount } from "./admin-gate.functions-CQAw6ivo.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/admin-BCFj4h1e.js
...
var shiprocketGetLabel = createServerFn({ method: "POST" }).inputValidator((orderId) => orderId).handler(createSsrRpc("4f99b4a4ff2324cef80e368d76b698b530aec804659d7d38fe3d96026d06d63e"));
var Tabs = Root2;
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TabsContent, {
					value: "images",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ImageMapperAdmin, {})
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TabsContent, {
					value: "settings",
...
function playAlarm() {
	try {
		...
		[
			...
			osc1.type = "square";
			osc1.frequency.setValueAtTime(987, now + offset);
			gain1.gain.setValueAtTime(1e-4, now + offset);
			gain1.gain.linearRampToValueAtTime(.5, now + offset + .02);
			gain1.gain.exponentialRampToValueAtTime(1e-4, now + offset + .12);
			osc1.connect(gain1).connect(ctx.destination);
			osc1.start(now + offset);
			osc1.stop(now + offset + .15);
			const osc2 = ctx.createOscillator();
			const gain2 = ctx.createGain();
			osc2.type = "sawtooth";
			osc2.frequency.setValueAtTime(880, now + offset);
			gain2.gain.setValueAtTime(1e-4, now + offset);
			gain2.gain.linearRampToValueAtTime(.3, now + offset + .02);
			gain2.gain.exponentialRampToValueAtTime(1e-4, now + offset + .12);
			osc2.connect(gain2).connect(ctx.destination);
			osc2.start(now + offset);
			osc2.stop(now + offset + .15);
		});
		setTimeout(() => ctx.close?.(), 4e3);
	} catch {}
}
...
function NotificationSettings() {
	...
	async function handleTestEmail() {
		...
		try {
			...
			if (res.success) toast.success(res.message || "SMTP verified successfully!");
			else {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "pt-2 border-t border-border flex flex-wrap gap-2",
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
							...
							children: testingEmail ? "Testing Connection..." : "Test Email Connection"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
							variant: "outline",
							onClick: () => {
...
function OrdersAdmin() {
	...
	const [printingId, setPrintingId] = (0, import_react.useState)(null);
	const { data } = useQuery({
		queryKey: ["adm-orders"],
		queryFn: () => list({})
	});
	async function handlePrintLabel(id) {
		setPrintingId(id);
		try {
			...
			} else toast.error("Failed to generate label URL");
		} catch (e) {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h5", {
											...
											children: [
												...
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													...
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
														...
														children: printingId === o.id ? "Generating Label..." : "Print/Download Shipping Label"
													})]
												})
											]
										}) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											}), (o.status === "paid" || o.status === "pending") && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
												size: "sm",
												type: "button",
...
function ProductsAdmin() {
	...
	function ProductForm({ p, id, onDone }) {
		const [imageUrl, setImageUrl] = (0, import_react.useState)(p?.image_url ?? "");
		...
		return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "sm:col-span-2",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, { children: "Product Image (upload or URL)" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MediaUploadField, {
						value: imageUrl,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				...
				children: addOpen ? "− Close" : "+ Add new product"
			}), addOpen && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "mt-4",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ProductForm, { onDone: () => setAddOpen(false) })
			})]
...
function ImageMapperAdmin() {
	...
	const [mappingId, setMappingId] = (0, import_react.useState)(null);
	async function handleMap(filename) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "bg-secondary/35 p-4 rounded-xl text-sm leading-relaxed border border-border",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
					className: "font-semibold text-foreground mb-1",
					children: "📦 Uploaded Product Images Mapper"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "text-muted-foreground text-xs",
					children: "Select which product each new pack image belongs to. Mapping will copy the image to the correct product slug name, update the product's image url in the database, and clear it from this mapping screen."
				})]
			}),
			loadingTemp && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "text-sm text-muted-foreground",
				children: "Loading images…"
			}),
			!tempImages?.length && !loadingTemp && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "text-sm text-muted-foreground bg-card border border-border rounded-xl p-8 text-center",
				children: "All images have been mapped! No new temp uploads found."
			}),
			tempImages && tempImages.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6",
				children: tempImages.map((filename) => {
					...
					return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "space-y-3",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "aspect-square w-full relative bg-secondary/20 rounded-lg overflow-hidden border border-border/50 flex items-center justify-center",
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
								...
								onValueChange: (val) => setSelectedProducts((prev) => ({
									...prev,
									[filename]: val
								})),
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectTrigger, {
								...
								size: "sm",
								children: mappingId === filename ? "Saving..." : "Map to Product"
							})]
						})]
					}, filename);
				})
