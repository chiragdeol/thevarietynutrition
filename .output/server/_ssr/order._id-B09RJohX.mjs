...
import { F as ClipboardCheck, G as ArrowRight, Y as CircleCheck, _ as QrCode } from "../_libs/lucide-react.mjs";
import { t as Route } from "./order._id-CK_oRN5s.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/order._id-B09RJohX.js
...
function OrderSuccess() {
	...
	const upiId = "thevarietynutrition@paytm";
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						...
						children: [
							...
							formatINR(data.order.total_cents),
							"**."
						]
					}),
